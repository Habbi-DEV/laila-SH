...
export default function ProductPage() {
  ...
  if (loading) return (<div className="min-h-screen bg-ivory"><TopBar showBack /><main className="max-w-md mx-auto pb-32"><ProductDetailSkeleton /></main></div>);
  if (err && !product) return (<div className="min-h-screen bg-ivory"><TopBar showBack /><p className="text-center text-rose py-32">{err}</p></div>);
